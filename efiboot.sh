...
declare -r KERNEL_PARAMETERS="root=/dev/mapper/vg_root-lv_root rw initrd=/EFI/arch/intel-ucode.img initrd=/EFI/arch/initramfs-linux.img intel_iommu=on nvidia-drm.modeset=1 ipv6.disable=1"
