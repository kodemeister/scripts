...
declare -r BACKUP_MOUNT_POINT="/media/backup"

declare -r ESP_MOUNT_POINT="/media/esp"
declare -r ESP_BACKUP_DIR="$BACKUP_MOUNT_POINT/esp"

declare -r ROOT_SNAPSHOT="/dev/vg_root/snap_root"
declare -r ROOT_BACKUP_FILE="$BACKUP_MOUNT_POINT/root/root.fsa"

declare -r STORAGE_SNAPSHOT="/dev/vg_storage/snap_storage"
